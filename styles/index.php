...
<body>
  ...
  <section class="alert alert-styles">
    <div class="container">
      <div class="card">
        <div class="card-header">
          <h5 class="card-title"><a href="motion-design/">Motion Design</a></h5>
          <p class="card-text">Motion design videos apply graphic design principles to video production using animation and effects.</p>
        </div>
        <div class="card-body">
          <div class="d-flex">
            <div class="col-lg-4">
        ...
        <div class="card-footer"> <a class="float-right card-link" href="motion-design/">More Examples...</a> </div>
      </div>
    </div>
  </section>
