  ...
  <div class="container-fluid h-100">
    <div class="d-flex h-100 text-center align-items-center mt-3">
      <div class="video-holder text-white">
        <h1 class="display-4 wow bounceInDown"><!-- InstanceBeginEditable name="h1" -->Custom Custom Presentations<!-- InstanceEndEditable --></h1>
...
<section class="pb-5 bg-light">
  <h1 class="text-center pt-1"><!-- InstanceBeginEditable name="examples" -->Video Presentations Examples<!-- InstanceEndEditable --></h1>
...
<section class="container-fluid bg-light py-2">
  <div class="card wow zoomIn">
    <h5 class="card-header bg-gradient-mine text-white text-center text-uppercase"><!-- InstanceBeginEditable name="h5" -->Custom Video Presentations<!-- InstanceEndEditable --></h5>
    <div class="card-body">
      <div class="row">
