...
<div id="get-a-quote">
	...
	<form name="Whiteboard Captcha" id="__vtigerWebForm" action="https://websitetalkingheads.od1.vtiger.com/modules/Webforms/capture.php" enctype="multipart/form-data" method="post" accept-charset="utf-8"><input name="__vtrftk" type="hidden" value="sid:e5bb315345fe9722a961b430a8f95313d6a09d80,1507275846">
		...
		<div class="inputs">
			<input name="lastname" required="" type="text" value="Name" data-label=""> </td>
			<input class="inputs-mt" name="email" required="" type="email" value="Email" data-label=""> </td>
			<input class="inputs-mt" name="phone" required="" type="text" value="Phone" data-label=""> </td>
			<input name="cf_1001" type="hidden" value="<?=$pageURL?>" data-label="">
			<input class="inputs-mt" name="designation" type="hidden" value="<?=$sentIP?>" data-label="">
			<textarea class="inputs-mt" name="description">Message</textarea>
		</div>
