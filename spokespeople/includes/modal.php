          ...
          <span aria-hidden="true">&times;</span></button>
			...
			<div class="d-flex justify-content-center">
				<video id="talking-heads-video" class="" controls preload="auto" data-setup="{}">
					<p>
						To view this video please enable JavaScript, and consider upgrading to a web browser that supports HTML5 video<br>
						<a href="https://www.websitetalkingheads.com/support/" target="_blank">Talking Heads Support</a>
					</p>
				</video>
			</div>
