...
echo '<div class="row spokespeople">';
echo PHP_EOL;
foreach ( $xml as $item ) {
	$actor = $item[ 'caption' ];
	...
	echo PHP_EOL;
	echo '<img src="https://websitetalkingheads.com/carimages/' . $actor . '.png" class="img-responsive img-circle" alt="' . $actor . ' - Video Spokesperson"/></a>';
	echo PHP_EOL;
