...
<html>
<head>
<title>Our Spokesmen|Live-Spokesperson</title>
...
<meda name="robots" content="index, follow"/>
<!-- (Robot commands: All, None, Index, No Index, Follow, No Follow) -->
<meda name="revisit-after" content="30 days"/>
<meda name="distribution" content="global"/>
<meda name="rating" content="general"/>
<meda name="Content-Language" content="english"/>
...
<section class="alert alert-info">
    <h1 class="text-center">Talking Heads<sup><i class="fal fa-registered"></i></sup></h1>
    <h2 class="text-center">Spokesmen</h2>
</section>
<section class="container-fluid my-3">
    <div class="row" style="min-height: 845px">
...
<section class="container-fluid bg-white">
    <div class="w-50 mx-auto">
        <div class="card middle">
            <h3 class="card-header bg-gradient-mine text-center text-white">Website <em>Spokespeople</em></h3>
