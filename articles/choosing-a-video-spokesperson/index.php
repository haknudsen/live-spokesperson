...
<body>
	...
	<section class="page-header text-center">
		<h1>Choose the Best Website Spokesperson for your Site</h1>
		<h2>Finding the Virtual Spokesperson that is right for you.</h2>
	</section>
	<section class="alert-info">
		<div class="p-4">
				<div class="w-50 float-left pr-2">
					<?php $video="Massive Wall Of Spokespeople";$alt="Many of our professional video spokespeople" ;include("../../includes/showInline.php"); ?>
				</div>
