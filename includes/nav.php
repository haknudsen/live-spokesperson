...
<nav class="navbar navbar-expand-xl navbar-dark bg-gradient-dark sticky-top animated fadeIn"> <a href="http://www.live-spokesperson.com/" title="Live-Spokesperson.com" class="navbar-brand float-left"><img src="https://www.websitetalkingheads.com/images/Talking_Heads_Banner_Logo.png" alt="Live-Spokesperson Logo" class="img-fluid" style="max-height: 98px" title="Live-Spokesperson Logo"/></a>
    ...
    <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
        <ul class="navbar-nav">
            ...
            <li class="nav-item" id="order"> <a class="nav-link" href="http://www.live-spokesperson.com/order">Order</a> </li>
