		...
		<div class="modal-content">
          ...
          <span aria-hidden="true">×</span>
					...
					<div class="d-flex justify-content-center btn-holder">
						<input class="btn submitButton" id="vtigerFormSubmitBtn" type="submit" value="SUBMIT">
					</div>
				</form>
...
</div><div id="mainModal" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg modal-dialog-centered">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="videoModalLabel"></h5>
						...
						<table>
							<tbody>
								<tr>
									...
									<td><input name="lastname" required="" type="text" maxlength="100" value="" data-label="name">
									</td>
								</tr>
								<tr>
									<td><label>Email*</label>
									</td>
									<td><input name="email" required="" type="email" value="" data-label="Primary Email">
									</td>
								</tr>
								<tr>
