    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="__vtigerWebForm" name="product demo" action="https://websitetalkingheads.od1.vtiger.com/modules/Webforms/capture.php" method="post" accept-charset="utf-8" enctype="multipart/form-data">
          ...
          <input type="hidden" name="cf_1001" maxlength="255" data-label="" value="<?=$pageURL?>">
          <table>
            <tbody>
              <tr>
                <td class="w-25"><label>Name </label></td>
                <td class="w-75"><input  type="text" name="lastname" maxlength="80" data-label="" value="" required=""></td>
              </tr>
              <tr>
                <td class="w-25"><label>Email </label></td>
                <td class="w-75"><input  type="email" name="email" data-label="Primary Email" value="" <="" td=""></td>
              </tr>
              <tr>
                <td class="w-25"><label>Phone </label></td>
                <td class="w-75"><input  type="text" name="phone" maxlength="50" data-label="" value=""></td>
              </tr>
              <tr>
                <td class="w-25"><label> Description </label></td>
                <td class="w-75"><textarea  name="description"></textarea></td>
              </tr>
            </tbody>
          </table>
