	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light"> <a class="navbar-brand" href="#"><img class="navbar-brand img img-fluid" src="https://www.websitetalkingheads.com/images/Talking_Heads_Banner_Logo.png" alt="Website Talking Heads"></a>
		...
		<div class="collapse navbar-collapse justify-content-center" id="navbarText">
			<ul class="navbar-nav">
				...
				<li class="nav-item" id="menuExamples"><a href="/examples/">Examples</a> </li>
				<li class="nav-item" id="menuPrices"><a href="/pricing/">Prices</a> </li>
				<li class="nav-item" id="menuOrder"><a href="/orderform/">Order</a> </li>
				<li class="nav-item" id="whiteboard"><a href="/whiteboard/">White<br>
        Board</a> </li>
