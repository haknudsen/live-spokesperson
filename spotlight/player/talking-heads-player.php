...
<style type="text/css">
    #player-holder{width: 400px;height: 400px}
</style>
...
<div id="player-holder">
    <video id="talking-head-player" preload playsinline width="100%" height="100%">
...
<script>
		$( document ).ready( function () {
			createTalkingHead( "<?=$video?>","<?=$autostart?>","<?=$controls?>","<?=$logo?>","<?=$color?>","<?=$size?>","<?=$captions?>" );
		} );
	</script>
</body>
</html>